...
{
    public abstract class ScreenPresenter<TView> : IDisposable
    {
        protected readonly CancellationTokenSource CancellationTokenSource = new();

        protected ScreenPresenter(TView view)
        {
            View = view;
        }
        ...
        public void Initialize()
        {
            ...
            if (IsDisposed)
            {
                throw new ObjectDisposedException(nameof(ScreenPresenter<TView>));
            }
    ...
    public abstract class ScreenPresenter<TView, TDataSource> : IDisposable
    {
        protected ScreenPresenter(TView view, TDataSource dataSource)
        {
            View = view;
        ...
        public void Initialize()
        {
            ...
            if (IsDisposed)
            {
                throw new ObjectDisposedException(nameof(ScreenPresenter<TView, TDataSource>));
            }
